...
from constants import PLAYER_RADIUS, LINE_WIDTH, PLAYER_TURN_SPEED, SCREEN_WIDTH, SCREEN_HEIGHT, PLAYER_SPEED, PLAYER_SHOOT_SPEED, PLAYER_SHOT_COOLDOWN_SECONDS
import math
...
class Player(CircleShape):
    ...
    def shoot(self):
        ...
        self.shoot_cd = PLAYER_SHOT_COOLDOWN_SECONDS
